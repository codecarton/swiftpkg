...
- **Child ticket**: a GitHub sub-issue where supported; otherwise link it from the map’s task list and add `Part of #<map>`.
- **Blocking**: use GitHub’s native issue dependencies where available, otherwise a `Blocked by: #<n>` line.
